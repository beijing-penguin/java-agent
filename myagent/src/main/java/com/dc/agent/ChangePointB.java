...
public class ChangePointB implements Opcodes {
	...
	public static byte[] dump() throws Exception {
		...
		classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "com/dc/mytest/debug/PointB", null, "java/lang/Object", null);

		classWriter.visitSource("PointB.java", null);
		...
		}
		{
			...
			methodVisitor.visitLocalVariable("this", "Lcom/dc/mytest/debug/PointB;", null, label0, label1, 0);
		...
		}
		{
			...
			methodVisitor.visitTypeInsn(NEW, "com/dc/mytest/debug/PointB");
			methodVisitor.visitInsn(DUP);
			methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/dc/mytest/debug/PointB", "<init>", "()V", false);
			...
			methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/dc/mytest/debug/PointB", "a", "(II)I", false);
			...
			methodVisitor.visitLocalVariable("this", "Lcom/dc/mytest/debug/PointB;", null, label0, label9, 0);
			...
			methodVisitor.visitLocalVariable("t", "Lcom/dc/mytest/debug/PointB;", null, label7, label9, 10);
		...
		}
		{
			...
			methodVisitor.visitLdcInsn(new Integer(3111111));
			methodVisitor.visitVarInsn(ISTORE, 3);
			Label label3 = new Label();
			methodVisitor.visitLabel(label3);
			...
			Label label8 = new Label();
			methodVisitor.visitLabel(label8);
			methodVisitor.visitLocalVariable("this", "Lcom/dc/mytest/debug/PointB;", null, label0, label8, 0);
			...
			methodVisitor.visitLocalVariable("t", "Lcom/dc/mytest/debug/PointB;", null, label7, label8, 8);
